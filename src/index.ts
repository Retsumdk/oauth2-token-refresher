#!/usr/bin/env bun
/**
 * oauth2-token-refresher - Automatic OAuth2 token refresh with caching
...
program.name("oauth2-token-refresher").description("Automatic OAuth2 token refresh with caching").version("1.0.0")
